...
/*
=== solid 원칙
 단일 책임 원칙 - 클래스는 하나의 책임만을 가짐
 개발 폐쇄 원칙 - 확장에 개방 수정에 폐쇄
 리스코프 처한 원칙 - 자식 클래스는 부모 클래스를 대체 할 수 있음
 인터 페이스 분리 - 자신이 사용하지 않으면 인터페이스에 의존하지 않음
 의존 역전 원칙 - 클래스 간의 결함을 낮추고 추상화에 의존해야 함
 */
